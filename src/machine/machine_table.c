...
const machine_t machines[] = {
    ...
    { "[Slot 1 BX] Gigabyte GA-6BXC",		"6bxc",			{{"Intel", cpus_PentiumII},   {"CVT", cpus_CeleCVT}, {"370", cpus_Celeron},  {"VIA", cpus_Cyrix3},{"",      NULL}}, MACHINE_PCI | MACHINE_ISA | MACHINE_AT | MACHINE_PS2 | MACHINE_HDC,			  		  8,  768,   8, 255,		 machine_at_6bxc_init, NULL			},
    ...
    { "[Slot 1 BX] ABit BF6",			"bf6",			{{"Intel", cpus_PentiumII},   {"CVT", cpus_CeleCVT}, {"370", cpus_Celeron},  {"VIA", cpus_Cyrix3},{"",      NULL}}, MACHINE_PCI | MACHINE_ISA | MACHINE_AT | MACHINE_PS2 | MACHINE_HDC,			  		  8,  768,   8, 255,		  machine_at_bf6_init, NULL			},
#else
...
#endif
#if defined(DEV_BRANCH) && defined(USE_I686)
    { "[Slot 1 ZX] Packard Bell Bora Pro",	"borapro",		{{"Intel", cpus_PentiumII},   {"CVT", cpus_CeleCVT}, {"370", cpus_Celeron},  {"VIA", cpus_Cyrix3},{"",      NULL}}, MACHINE_PCI | MACHINE_ISA | MACHINE_AT | MACHINE_PS2 | MACHINE_HDC,			 		  8,  512,   8, 255,	      machine_at_borapro_init, NULL			},
