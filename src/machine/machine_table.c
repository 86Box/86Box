...
const machine_t machines[] = {
    ...
    },
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_8088_EUROPC,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
    ...
    /* Has IBM PS/2 Type 1 KBC firmware. */
    {
        ...
        .cpu_package = CPU_PKG_286,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 10000000,
        .cpu_max_bus = 10000000,
        .cpu_min_voltage = 0,
        .cpu_max_voltage = 0,
        .cpu_min_multi = 0,
        .cpu_max_multi = 0,
    ...
    /* Has IBM PS/2 Type 1 KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_286 | CPU_PKG_486SLC_IBM,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 10000000,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
    ...
    /* Has AMIKey H KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_486SLC_IBM,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
    ...
    /* Has IBM PS/2 Type 1 KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_386DX | CPU_PKG_486BL,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
    ...
    /* Has IBM PS/2 Type 1 KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_386DX | CPU_PKG_486BL | CPU_PKG_SOCKET1,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
       ...
       Phoenix MultiKey commands. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_386DX | CPU_PKG_SOCKET1,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
    ...
    /* Has IBM PS/2 Type 1 KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET3_PC330,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 25000000,
        .cpu_max_bus = 33333333,
        .cpu_min_voltage = 0,
        .cpu_max_voltage = 0,
        .cpu_min_multi = 2.0,
        .cpu_max_multi = 3.0,
       ...
       must be an ASIC that clones the standard IBM PS/2 KBC. */
    {
        ...
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET3,
        .cpu_block = CPU_BLOCK(CPU_i486SX, CPU_i486DX, CPU_Am486SX, CPU_Am486DX),
        .cpu_min_bus = 0,
        .cpu_max_bus = 0,
        .cpu_min_voltage = 0,
        .cpu_max_voltage = 0,
       ...
       firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_STPC,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 66666667,
        .cpu_max_bus = 75000000,
        .cpu_min_voltage = 0,
        .cpu_max_voltage = 0,
        .cpu_min_multi = 1.0,
        .cpu_max_multi = 1.0,
       ...
       to be clear. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET4,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 60000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 5000,
        .cpu_max_voltage = 5000,
        .cpu_min_multi = MACHINE_MULTIPLIER_FIXED,
        .cpu_max_multi = MACHINE_MULTIPLIER_FIXED,
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL,
        .min_ram = 2048,
        .max_ram = 131072,
    ...
    /* This has the Phoenix MultiKey KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET5_7,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 50000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 3520,
        .cpu_max_voltage = 3520,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 1.5,
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL,
       ...
       (Set Extended Controller RAM) just like the later Intel AMI BIOS'es. */
    {
        ...
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET5_7,
        .cpu_block = CPU_BLOCK(CPU_K5, CPU_5K86),
        .cpu_min_bus = 50000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 3520,
        .cpu_max_voltage = 3520,
    ...
    /* Has an AMI 'H' KBC firmware (1992). */
    {
        ...
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET5_7,
        .cpu_block = CPU_BLOCK(CPU_WINCHIP, CPU_WINCHIP2, CPU_Cx6x86, CPU_Cx6x86L, CPU_Cx6x86MX),
        .cpu_min_bus = 50000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 3380,
        .cpu_max_voltage = 3520,
    ...
    /* Has SST flash and the SMC FDC73C935's on-chip KBC with Phoenix MultiKey firmware. */
    {
        ...
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET5_7,
        .cpu_block = CPU_BLOCK(CPU_Cx6x86MX),
        .cpu_min_bus = 50000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 2800,
        .cpu_max_voltage = 3520,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 3.0,
        .bus_flags = MACHINE_PS2_PCI,
    ...
    /* The BIOS sends KBC command B8, CA, and CB, so it has an AMI KBC firmware. */
    {
        ...
        .cpu_min_bus = 66666667,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 1900,
        .cpu_max_voltage = 2800,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 5.5,
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL,
    ...
    /* Has the ALi M1543C southbridge with on-chip KBC. */
    {
        ...
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 60000000,
        .cpu_max_bus = 120000000,
        .cpu_min_voltage = 2000,
        .cpu_max_voltage = 3520,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 5.5,
        .bus_flags = MACHINE_PS2_AGP,
    ...
    /* Has the ALi M1543C southbridge with on-chip KBC. */
    {
        ...
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 66666667,
        .cpu_max_bus = 140000000,
        .cpu_min_voltage = 1300,
        .cpu_max_voltage = 3520,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 5.5,
        .bus_flags = MACHINE_PS2_AGP,
       ...
       VT82C42N. */
    {
        ...
        .cpu_min_bus = 66666667,
        .cpu_max_bus = 124242424,
        .cpu_min_voltage = 1800,
        .cpu_max_voltage = 3100,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 5.5,
    ...
    /* This has an AMIKey-2, which is an updated version of type 'H'. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SOCKET8,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 60000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 2100,
        .cpu_max_voltage = 3500,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 8.0,
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL,
       ...
       the MB-8600TTC until someone can actually identify it. */
    {
        ...
        .cpu_min_bus = 50000000,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 2900,
        .cpu_max_voltage = 3300,
        .cpu_min_multi = 2.0,
        .cpu_max_multi = 5.5,
        .bus_flags = MACHINE_PS2_PCI,
        .flags = MACHINE_IDE_DUAL,
       ...
       with most likely AMIKey-2 KBC firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SLOT1 | CPU_PKG_SLOT2,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 100000000,
        .cpu_max_bus = 150000000,
        .cpu_min_voltage = 1800,
       ...
       firmware. */
    {
        ...
        .pad1 = MACHINE_AVAILABLE,
        .pad2 = 0,
        .cpu_package = CPU_PKG_SLOT1 | CPU_PKG_SOCKET370,
        .cpu_block = CPU_BLOCK_NONE,
        .cpu_min_bus = 66666667,
        .cpu_max_bus = 133333333,
        .cpu_min_voltage = 1300,
       ...
       firmware. */
    {
        ...
        .cpu_max_voltage = 3500,
        .cpu_min_multi = 1.5,
        .cpu_max_multi = 8.0, /* limits assumed */
        .bus_flags = MACHINE_PS2_AGP,
        .flags = MACHINE_IDE_DUAL,
        .min_ram = 8192,
        .max_ram = 524288,
       ...
       firmware. */
    {
        ...
        .pad2 = 0,
        .cpu_package = CPU_PKG_SLOT1,
        .cpu_block = CPU_BLOCK(CPU_PENTIUM2, CPU_CYRIX3S),
        .cpu_min_bus = 0,
        .cpu_max_bus = 66666667,
        .cpu_min_voltage = 0,
        .cpu_max_voltage = 0,
