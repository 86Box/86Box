...
const machine_t machines[] = {
  // clang-format off
    ...
    /* Has a standard PS/2 KBC (so, use IBM PS/2 Type 1). */
    {
        ...
        .jumpered_ecp_dma = 0,
        .default_jumpered_ecp_dma = -1,
        .kbc_device = &kbc_at_xi8088_device,
        .kbc_p1 = 0x00400cf0,
        .gpio = 0xffffffff,
        .gpio_acpi = 0xffffffff,
    ...
    /* Has IBM PS/2 Type 2 KBC firmware. */
    {
        ...
        .jumpered_ecp_dma = 0,
        .default_jumpered_ecp_dma = -1,
        .kbc_device = &kbc_at_ibm_mca_device,
        .kbc_params = KBC_FLAG_IS_TYPE2,
        .kbc_p1 = 0x00000cf0,
        .gpio = 0xffffffff,
        .gpio_acpi = 0xffffffff,
        .device = NULL,
       ...
       the keyboard controller, but it's possibly a Phoenix. */
    {
        ...
        .jumpered_ecp_dma = 0,
        .default_jumpered_ecp_dma = -1,
        .kbc_device = &kbc_at_phoenix_device, /* Possibly. */
    ...
    /* TriGem AMIBIOS Pre-Color with TriGem AMI 'Z' keyboard controller */
    {
        ...
        .jumpered_ecp_dma = 0,
        .default_jumpered_ecp_dma = -1,
        .kbc_device = &kbc_at_ami_tg_device,
       ...
       in -H, so the UMC on-chip KBC likely emulates the AMI 'H' KBC firmware. */
    {
        ...
        .jumpered_ecp_dma = MACHINE_DMA_DISABLED | MACHINE_DMA_1 | MACHINE_DMA_3,
        .default_jumpered_ecp_dma = 3,
        .kbc_device = &kbc_at_ami_tg_device, /* Guess. */
