...
const machine_t machines[] = {
    ...
    { "[ETEQ ET6000] Olivetti PCS-46C",		"pcs46c",		MACHINE_TYPE_486,		CPU_PKG_SOCKET1, 0, 0, 0, 0, 0, 0, 0,										MACHINE_AT | MACHINE_IDE | MACHINE_VIDEO,									 1024, 65536, 1024, 127,	       machine_at_pcs46c_init, at_pcs46c_get_device			},
