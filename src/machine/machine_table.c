...
const machine_t machines[] = {
    ...
    { "[Socket 5 FX] NEC Powermate V",  	"powermate_v",		MACHINE_CPUS_PENTIUM_S5,											    MACHINE_PCI | MACHINE_ISA | MACHINE_AT | MACHINE_HDC,						  8,  128,   8, 127,	  machine_at_powermate_v_init, NULL			},
