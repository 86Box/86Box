...
const machine_t machines[] = {
    ...
    { "[8088] IBM PCjr",			"ibmpcjr",		MACHINE_TYPE_8088_PCJR,		CPU_PKG_8088, 0, 0, 0, 0, 0, 0, 0,										MACHINE_PC | MACHINE_VIDEO_FIXED,						  128,   640, 128,    0,		    machine_pcjr_init, pcjr_get_device		},
