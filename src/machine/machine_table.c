...
const machine_t machines[] = {
    ...
    { "[Contaq 82C59x] Contaq 486",		"contaq",		MACHINE_TYPE_486,		{{"Intel", cpus_i486},      {"AMD", cpus_Am486}, {"Cyrix", cpus_Cx486},{"",      NULL},     {"",      NULL}}, MACHINE_ISA | MACHINE_AT,						  1,   64,   1, 127,	      machine_at_contaq_init, NULL			},    
