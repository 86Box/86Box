...
static void
machine_at_ruby_gpio_init(void)
{
...
machine_at_hpruby_init(const machine_t *model)
{
    ...
    ret = bios_load_linear_combined("roms/machines/hpruby/1007DC0L.BIO",
                                    "roms/machines/hpruby/1007DC0L.BI1",
                                    0x20000, 128);
