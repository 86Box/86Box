...
static const device_config_t p2bls_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 },
        .bios = {
            { .name = "Award Modular BIOS v4.51PG - Revision 1012", .internal_name = "p2bls", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p2bls/1012ls.awd", "" } },
            { .name = "Award Modular BIOS v4.51PG - Revision 1014 Beta 003", .internal_name = "p2bls_1014b003", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p2bls/1014ls.003", "" } },
            { .files_no = 0 }
        },
    },
    { .name = "", .description = "", .type = CONFIG_END }
...
static const device_config_t p3bf_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 },
        .bios = {
            { .name = "Award Modular BIOS v4.51PG - Revision 1006", .internal_name = "p3bf", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3bf/1006f.awd", "" } },
            { .name = "Award Modular BIOS v4.51PG - Revision 1008 Beta 004", .internal_name = "p3bf_1008b004", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3bf/1008f.004", "" } },
            { .files_no = 0 }
        },
    },
    { .name = "", .description = "", .type = CONFIG_END }
...
static const device_config_t ms6147_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 },
        .bios = {
            { .name = "Award Modular BIOS v4.51PG - Revision 1.8", .internal_name = "ms6147", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/ms6147/W647MS18.BIN", "" } },
            { .name = "Award Modular BIOS v4.51PG - Revision 2.1 (Packard Bell Tempest)", .internal_name = "tempest", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/ms6147/w647p221.pbc", "" } },
            { .files_no = 0 }
        },
    },
    { .name = "", .description = "", .type = CONFIG_END }
...
static const device_config_t p3v133_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 },
        .bios = {
            { .name = "Award Modular BIOS v4.51PG - Revision 1002", .internal_name = "p3v133", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3v133/1003.awd", "" } },
            { .name = "Award Modular BIOS v4.51PG - Revision 1003 Beta 002", .internal_name = "p3v133_1003b002", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3v133/1003.002", "" } },
            { .files_no = 0 }
        },
    },
    { .name = "", .description = "", .type = CONFIG_END }
...
static const device_config_t p3v4x_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 },
        .bios = {
            { .name = "Award Modular BIOS v4.51PG - Revision 1005", .internal_name = "p3v4x", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3v4x/1005.awd", "" } },
            { .name = "Award Modular BIOS v4.51PG - Revision 1006 Beta 004", .internal_name = "p3v4x_1006b004", .bios_type = BIOS_NORMAL, 
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/p3v4x/1006.004", "" } },
            { .files_no = 0 }
        },
    },
    { .name = "", .description = "", .type = CONFIG_END }
