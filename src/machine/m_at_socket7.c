...
int
machine_at_gw2kmm_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear_combined2(L"roms/machines/gw2kmm/1007DQ0T.BIO",
				     L"roms/machines/gw2kmm/1007DQ0T.BI1",
				     L"roms/machines/gw2kmm/1007DQ0T.BI2",
				     L"roms/machines/gw2kmm/1007DQ0T.BI3",
				     L"roms/machines/gw2kmm/1007DQ0T.RCV",
				     0x3a000, 128);
