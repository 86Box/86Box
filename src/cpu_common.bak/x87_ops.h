...
const OpFn OP_TABLE(fpu_287_d9_a32)[256] =
{
        ...
        opF2XM1,      opFYL2X,      opFPTAN,      opFPATAN,     ILLEGAL_a32,  ILLEGAL_a32,  opFDECSTP,    opFINCSTP,
        opFPREM,      opFYL2XP1,    opFSQRT,      ILLEGAL_a32,  opFRNDINT,    opFSCALE,     ILLEGAL_a32,  ILLEGAL_a32
};
