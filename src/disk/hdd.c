...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[ATA-2] Western Digital Caviar 2850",              .internal_name = "WDAC2850", .model = "WDC WDAC2850-00F", .zones =  4,  .avg_spt = 115, .heads = 2, .rpm = 4500, .full_stroke_ms = 12, .track_seek_ms = 4,   .rcache_num_seg =  8, .rcache_seg_size =  128, .max_multiple =  8 },
    ...
    { .name = "[ATA-4] Western Digital Caviar 33200",             .internal_name = "WDAC33200", .model = "WDC WDAC33200-00LA", .zones =  16,  .avg_spt = 110, .heads = 5, .rpm = 5200, .full_stroke_ms = 40, .track_seek_ms = 3,   .rcache_num_seg =  8, .rcache_seg_size =  256, .max_multiple =  32 },
