...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    /* ESDI drives */
    { .name = "[ESDI] IBM 0667 (Grant)",                          .internal_name = "IBM0667",     .vendor = "IBM",     .model = "0667",                                                        .zones =  1, .avg_spt =  36, .heads =  7, .rpm = 3600,  .full_stroke_ms = 60, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =   36, .max_multiple =  1 },
    { .name = "[ESDI] IBM 0669 (Grant-Prime)",                    .internal_name = "IBM0669",     .vendor = "IBM",     .model = "0669",                                                        .zones =  1, .avg_spt =  36, .heads =  7, .rpm = 3600,  .full_stroke_ms = 60, .track_seek_ms = 6,   .rcache_num_seg =  1, .rcache_seg_size =   36, .max_multiple =  1 },
    { .name = "[ESDI] IBM 0671 (Lee)",                            .internal_name = "IBM0671",     .vendor = "IBM",     .model = "0671",                                                        .zones =  1, .avg_spt =  34, .heads = 15, .rpm = 3283,  .full_stroke_ms = 50, .track_seek_ms = 5.5, .rcache_num_seg =  1, .rcache_seg_size =   34, .max_multiple =  1 },
    { .name = "[ESDI] CDC 94156-48 (Wren II 48M)",                .internal_name = "CDC9415648",  .vendor = "CDC",     .model = "94156-48",                                                    .zones =  1, .avg_spt =  17, .heads =  5, .rpm = 3600,  .full_stroke_ms = 65, .track_seek_ms = 5,   .rcache_num_seg =  1, .rcache_seg_size =   17, .max_multiple =  1 },
    { .name = "[ESDI] CDC 94166-101 (Wren III 101M)",             .internal_name = "CDC94166101", .vendor = "CDC",     .model = "94166-101",                                                   .zones =  1, .avg_spt =  34, .heads =  5, .rpm = 3597,  .full_stroke_ms = 40, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =   34, .max_multiple =  1 },
    { .name = "[ESDI] CDC 94166-141 (Wren III 141M)",             .internal_name = "CDC94166141", .vendor = "CDC",     .model = "94166-141",                                                   .zones =  1, .avg_spt =  34, .heads =  7, .rpm = 3597,  .full_stroke_ms = 40, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =   34, .max_multiple =  1 },
    { .name = "[ESDI] CDC 94186-383 (Wren V 383M)",               .internal_name = "CDC94186383", .vendor = "CDC",     .model = "94186-383",                                                   .zones =  1, .avg_spt =  36, .heads = 13, .rpm = 3600,  .full_stroke_ms = 40, .track_seek_ms = 4,   .rcache_num_seg =  1, .rcache_seg_size =   36, .max_multiple =  1 },
    ...
    { .name = "[SCSI-2] IBM Deskstar XP 540",                     .internal_name = "DPES30540",   .vendor = "IBM",     .model = "DPES-30540",                                                  .zones = 16, .avg_spt = 280, .heads =  4, .rpm = 5400,  .full_stroke_ms = 22, .track_seek_ms = 2.3, .rcache_num_seg = 16, .rcache_seg_size =   56, .max_multiple = 16 },
    { .name = "[SCSI-2] IBM Deskstar XP 810",                     .internal_name = "DPES30810",   .vendor = "IBM",     .model = "DPES-30810",                                                  .zones = 16, .avg_spt = 280, .heads =  4, .rpm = 5400,  .full_stroke_ms = 22, .track_seek_ms = 2.3, .rcache_num_seg = 16, .rcache_seg_size =   56, .max_multiple = 16 },
    { .name = "[SCSI-2] IBM Deskstar XP 1080",                    .internal_name = "DPES31080",   .vendor = "IBM",     .model = "DPES-31080",                                                  .zones = 16, .avg_spt = 280, .heads =  4, .rpm = 5400,  .full_stroke_ms = 22, .track_seek_ms = 2.3, .rcache_num_seg = 16, .rcache_seg_size =   56, .max_multiple = 16 },
