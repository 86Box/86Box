...
static hdd_preset_t hdd_speed_presets[] = {
  // clang-format off
    ...
    { .name = "[MFM] Kalok KL-330 (32 MB)",                       .internal_name = "KL330",        .model = "KL-330",                                                      .zones =  1, .avg_spt =  26, .heads =  4, .rpm = 3600, .full_stroke_ms = 40, .track_seek_ms = 10,  .rcache_num_seg =  1, .rcache_seg_size =   32, .max_multiple =  1 },
