...
static __inline int64_t x87_round_save(void)
{
    old_round = fetgetround();
}

static __inline int64_t x87_round_set(void)
{
    old_round = fetgetround();
...
static __inline int64_t x87_round_restore(void)
{
