...
extern void pic_init_convertible(void (*wake)(void));
extern uint8_t pic_convertible_diag_read(uint8_t selector);
extern void pic_convertible_diag_write(uint8_t value);
extern void pic_convertible_diag_enable(int enabled);
