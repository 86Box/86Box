...
extern void    video_lightpen_set_callbacks(void* priv, void (*lightpen_hsync)(void*), void (*lightpen_vsync)(void*), void (*lightpen_trigger_strobe)(void* priv, int x, int y, int x_offset_from_hsync, int firstline, double hpix_clock, int monitor_used));
extern void    video_lightpen_hsync(void);
extern void    video_lightpen_vsync(void);
extern void    video_lightpen_check_trigger_strobe(int x, int y, int hsync_offset, double hpix_clock); // only the horizontal scan rate is needed here.
