...
extern void    *plat_mmap_replaceable(size_t size, uintptr_t* out_handle);
extern void     plat_mmap_slice(void* addr, size_t size_of_chunk, size_t num);
extern void     plat_mmap_unfixed(size_t size, uintptr_t* out_handle, void* addr);
extern void    *plat_mmap_fixed(size_t size, uint8_t executable, void* addr, uint64_t offset, uintptr_t* out_handle);
