...
void ne2000_generate_maclocal(uint32_t mac)
{
...
void ne2000_generate_maclocal_pci(uint32_t mac)
{
...
uint32_t net2000_get_maclocal_pci()
{
	uint32_t temp;
...
void *ne2000_init(void)
{
	...
	network_add_handler(ne2000_poller, ne2000);
