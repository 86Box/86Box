...
const cpu_family_t cpu_families[] = {
	...
	.cpus = (const CPU[]) {
		{"533",       CPU_PENTIUM3,  fpus_internal, 533333333, 8.0, 1500,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 60},
		{"566",       CPU_PENTIUM3,  fpus_internal, 566666666, 8.5, 1500,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 60},
		{"600",       CPU_PENTIUM3,  fpus_internal, 600000000, 9.0, 1500,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"633",       CPU_PENTIUM3,  fpus_internal, 633333333, 9.5, 1500,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"666",       CPU_PENTIUM3,  fpus_internal, 666666666, 10.0, 1500,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"700",       CPU_PENTIUM3,  fpus_internal, 700000000, 10.5, 1650,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"733",       CPU_PENTIUM3,  fpus_internal, 733333333, 11.0, 1650,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"766",       CPU_PENTIUM3,  fpus_internal, 750000000, 11.5, 1650,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"800",       CPU_PENTIUM3,  fpus_internal, 800000000, 8.0, 1650,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"850",       CPU_PENTIUM3,  fpus_internal, 850000000, 8.5, 1700,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"900",       CPU_PENTIUM3,  fpus_internal, 900000000, 9.0, 1750,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"950",       CPU_PENTIUM3,  fpus_internal, 950000000, 9.5, 1750,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"1000",      CPU_PENTIUM3,  fpus_internal, 1000000000, 10.0, 1750,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"1100",      CPU_PENTIUM3,  fpus_internal, 1100000000, 11.0, 1750,  0x673,  0x673, 0, CPU_SUPPORTS_DYNAREC | CPU_REQUIRES_DYNAREC, 41,41,14,14, 72},
		{"", 0}
	}
	}, {
