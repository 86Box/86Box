...
const cpu_family_t cpu_families[] = {
	...
	.cpus = (const CPU[]) {
		{"800",     CPU_CYRIX3S, fpus_internal, 800000000, 8.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},\
		{"800/133", CPU_CYRIX3S, fpus_internal, 800000000, 6.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"850",     CPU_CYRIX3S, fpus_internal, 850000000, 8.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"866",     CPU_CYRIX3S, fpus_internal, 866666666, 6.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"900",     CPU_CYRIX3S, fpus_internal, 900000000, 9.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"933",     CPU_CYRIX3S, fpus_internal, 933333333, 7.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1000",    CPU_CYRIX3S, fpus_internal, 1000000000,7.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"", 0}
	}
    }, {
	.package = CPU_PKG_SOCKET370,
	...
	.cpus = (const CPU[]) {
		{"1000", CPU_CYRIX3S, fpus_internal,   1000000000, 7.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1133", CPU_CYRIX3S, fpus_internal,   1333333333, 8.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1200", CPU_CYRIX3S, fpus_internal,   1200000000, 9.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1200/200", CPU_CYRIX3S, fpus_internal,   1200000000, 6.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1300", CPU_CYRIX3S, fpus_internal,   1300000000,10.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1300/200", CPU_CYRIX3S, fpus_internal,   1300000000, 6.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1400", CPU_CYRIX3S, fpus_internal,   1400000000,10.5, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"1400/200", CPU_CYRIX3S, fpus_internal,   1400000000, 7.0, 2050,   0x663, 0x663, 0, CPU_SUPPORTS_DYNAREC | CPU_FIXED_MULTIPLIER, 63, 63, 21, 21, 84},
		{"", 0}
	}
    }, {
	.package = 0,
