...
static int opPAVGB_xmm_xmm_a16(uint32_t fetchdat)
{
    ...
    else
    {
        ...
        src[14] = readmemb(easeg, cpu_state.eaaddr + 14); if (cpu_state.abrt) return 1;
        src[15] = readmemb(easeg, cpu_state.eaaddr + 15); if (cpu_state.abrt) return 1;
        cpu_state.XMM[cpu_reg].b[0] = (cpu_state.XMM[cpu_reg].b[0] + src[0] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[1] = (cpu_state.XMM[cpu_reg].b[1] + src[1] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[2] = (cpu_state.XMM[cpu_reg].b[2] + src[2] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[3] = (cpu_state.XMM[cpu_reg].b[3] + src[3] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[4] = (cpu_state.XMM[cpu_reg].b[4] + src[4] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[5] = (cpu_state.XMM[cpu_reg].b[5] + src[5] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[6] = (cpu_state.XMM[cpu_reg].b[6] + src[6] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[7] = (cpu_state.XMM[cpu_reg].b[7] + src[7] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[8] = (cpu_state.XMM[cpu_reg].b[8] + src[8] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[9] = (cpu_state.XMM[cpu_reg].b[9] + src[9] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[10] = (cpu_state.XMM[cpu_reg].b[10] + src[10] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[11] = (cpu_state.XMM[cpu_reg].b[11] + src[11] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[12] = (cpu_state.XMM[cpu_reg].b[12] + src[12] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[13] = (cpu_state.XMM[cpu_reg].b[13] + src[13] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[14] = (cpu_state.XMM[cpu_reg].b[14] + src[14] + 1) >> 1;
        cpu_state.XMM[cpu_reg].b[15] = (cpu_state.XMM[cpu_reg].b[15] + src[15] + 1) >> 1;
    }
    return 0;
}
