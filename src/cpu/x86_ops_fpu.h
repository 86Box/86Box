...
opESCAPE_d8_a16(uint32_t fetchdat)
{
    ...
    int ret = x86_opcodes_d8_a16[(fetchdat >> 3) & 0x1f](fetchdat);
    if (fpu_softfloat) {
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_d8_a32[(fetchdat >> 3) & 0x1f](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_d9_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_d9_a32[fetchdat & 0xff](fetchdat);
    cpu_state.fpu_op = x87_op;
    cpu_state.fpu_CS = cpu_state.temp_CS;
    cpu_state.fpu_cs = cpu_state.temp_cs;
    cpu_state.fpu_pc = cpu_state.temp_pc;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_da_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_da_a32[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_db_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_db_a32[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_dc_a16[(fetchdat >> 3) & 0x1f](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_dc_a32[(fetchdat >> 3) & 0x1f](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_dd_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_dd_a32[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_de_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_de_a32[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_df_a16[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
...
{
    x87_op = ((opcode & 0x07) << 8) | (fetchdat & 0xff);
    int ret = x86_opcodes_df_a32[fetchdat & 0xff](fetchdat);
    if (fpu_softfloat) {
        FPU_check_pending_exceptions();
    }
    cpu_state.fpu_op = x87_op;
