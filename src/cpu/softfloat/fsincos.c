...
/* reduce trigonometric function argument using 128-bit precision
   M_PI approximation */
static Bit64u
argument_reduction_kernel(Bit64u aSig0, int Exp, Bit64u *zSig0, Bit64u *zSig1)
{
...
static int
reduce_trig_arg(int expDiff, int *zSign, Bit64u *aSig0, Bit64u *aSig1)
{
...
{
    const floatx80 floatx80_one = packFloatx80(0, 0x3fff, BX_CONST64(0x8000000000000000));
...
static floatx80
sincos_approximation(int neg, float128 r, Bit64u quotient, float_status_t *status)
{
    if (quotient & 0x1) {
        r = poly_cos(r, status);
        neg = 0;
...
int
fsincos(floatx80 a, floatx80 *sin_a, floatx80 *cos_a, float_status_t *status)
{
...
int
fsin(floatx80 *a, float_status_t *status)
{
    return fsincos(*a, a, 0, status);
}

int
fcos(floatx80 *a, float_status_t *status)
{
...
int
ftan(floatx80 *a, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
