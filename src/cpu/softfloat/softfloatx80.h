...
static __inline int floatx80_compare_two(floatx80 a, floatx80 b, float_status_t *status)
{
    return floatx80_compare(a, b, 0, status);
}

static __inline int floatx80_compare_quiet(floatx80 a, floatx80 b, float_status_t *status)
{
