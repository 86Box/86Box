...
float_raise(float_status_t *status, int flags)
{
...
static __inline int
get_exception_flags(const float_status_t *status)
{
...
static __inline int
float_exception_masked(const float_status_t *status, int flag)
{
...
static __inline int
get_float_rounding_mode(const float_status_t *status)
{
...
#ifdef FLOATX80
static __inline int
get_float_rounding_precision(const float_status_t *status)
{
...
static __inline int
get_float_nan_handling_mode(const float_status_t *status)
{
...
#ifdef FLOATX80
static __inline void
set_float_rounding_up(float_status_t *status)
{
...
static __inline int
get_denormals_are_zeros(const float_status_t *status)
{
...
static __inline int
get_flush_underflow_to_zero(const float_status_t *status)
{
...
static __inline float32
float32_round_to_int_one(float32 a, float_status_t *status)
{
  return float32_round_to_int(a, 0, status);
}

static __inline float32
float32_fmadd(float32 a, float32 b, float32 c, float_status_t *status)
{
  return float32_muladd(a, b, c, 0, status);
}

static __inline float32
float32_fmsub(float32 a, float32 b, float32 c, float_status_t *status)
{
  return float32_muladd(a, b, c, float_muladd_negate_c, status);
}

static __inline float32
float32_fnmadd(float32 a, float32 b, float32 c, float_status_t *status)
{
  return float32_muladd(a, b, c, float_muladd_negate_product, status);
}

static __inline float32
float32_fnmsub(float32 a, float32 b, float32 c, float_status_t *status)
{
  return float32_muladd(a, b, c, float_muladd_negate_result, status);
}

static __inline int
float32_compare_two(float32 a, float32 b, float_status_t *status)
{
  return float32_compare(a, b, 0, status);
}

static __inline int float32_compare_quiet(float32 a, float32 b, float_status_t *status)
{
...
static __inline float64
float64_round_to_int_one(float64 a, float_status_t *status)
{
  return float64_round_to_int(a, 0, status);
}

static __inline float64
float64_fmadd(float64 a, float64 b, float64 c, float_status_t *status)
{
  return float64_muladd(a, b, c, 0, status);
}

static __inline float64
float64_fmsub(float64 a, float64 b, float64 c, float_status_t *status)
{
  return float64_muladd(a, b, c, float_muladd_negate_c, status);
}

static __inline float64
float64_fnmadd(float64 a, float64 b, float64 c, float_status_t *status)
{
  return float64_muladd(a, b, c, float_muladd_negate_product, status);
}

static __inline float64
float64_fnmsub(float64 a, float64 b, float64 c, float_status_t *status)
{
  return float64_muladd(a, b, c, float_muladd_negate_result, status);
}

static __inline int
float64_compare_two(float64 a, float64 b, float_status_t *status)
{
  return float64_compare(a, b, 0, status);
}

static __inline int float64_compare_quiet(float64 a, float64 b, float_status_t *status)
{
