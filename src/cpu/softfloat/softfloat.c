...
float32
int32_to_float32(Bit32s a, float_status_t *status)
{
    if (a == 0) return 0;
...
float32
int64_to_float32(Bit64s a, float_status_t *status)
{
    if (a == 0) return 0;
    int zSign = (a < 0);
...
float64
int64_to_float64(Bit64s a, float_status_t *status)
{
    if (a == 0) return 0;
...
float32
uint32_to_float32(Bit32u a, float_status_t *status)
{
    if (a == 0) return 0;
...
float32
uint64_to_float32(Bit64u a, float_status_t *status)
{
    if (a == 0) return 0;
...
float64
uint64_to_float64(Bit64u a, float_status_t *status)
{
    if (a == 0) return 0;
...
Bit32s
float32_to_int32(float32 a, float_status_t *status)
{
...
Bit32s
float32_to_int32_round_to_zero(float32 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit32u aSig;
...
Bit32u
float32_to_uint32_round_to_zero(float32 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit32u aSig;
...
Bit64s
float32_to_int64(float32 a, float_status_t *status)
{
...
Bit64s
float32_to_int64_round_to_zero(float32 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit32u aSig;
...
Bit64u
float32_to_uint64_round_to_zero(float32 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit32u aSig;
...
Bit64u
float32_to_uint64(float32 a, float_status_t *status)
{
    int aSign;
...
Bit32u
float32_to_uint32(float32 a, float_status_t *status)
{
...
float64
float32_to_float64(float32 a, float_status_t *status)
{
    Bit32u aSig = extractFloat32Frac(a);
    Bit16s aExp = extractFloat32Exp(a);
    int  aSign = extractFloat32Sign(a);
...
float32
float32_round_to_int(float32 a, Bit8u scale, float_status_t *status)
{
...
float32
float32_frc(float32 a, float_status_t *status)
{
    int roundingMode = get_float_rounding_mode(status);
...
float32
float32_getexp(float32 a, float_status_t *status)
{
    Bit16s aExp = extractFloat32Exp(a);
    Bit32u aSig = extractFloat32Frac(a);
...
float32
float32_getmant(float32 a, float_status_t *status, int sign_ctrl, int interv)
{
    Bit16s aExp = extractFloat32Exp(a);
    Bit32u aSig = extractFloat32Frac(a);
    int aSign = extractFloat32Sign(a);
...
float32
float32_scalef(float32 a, float32 b, float_status_t *status)
{
    Bit32u aSig = extractFloat32Frac(a);
    Bit16s aExp = extractFloat32Exp(a);
    int aSign = extractFloat32Sign(a);
...
static float32
addFloat32Sigs(float32 a, float32 b, int zSign, float_status_t *status)
{
...
static float32
subFloat32Sigs(float32 a, float32 b, int zSign, float_status_t *status)
{
    Bit16s aExp, bExp, zExp;
    Bit32u aSig, bSig, zSig;
    Bit16s expDiff;
...
float32
float32_add(float32 a, float32 b, float_status_t *status)
{
    int aSign = extractFloat32Sign(a);
    int bSign = extractFloat32Sign(b);
...
float32
float32_sub(float32 a, float32 b, float_status_t *status)
{
    int aSign = extractFloat32Sign(a);
    int bSign = extractFloat32Sign(b);
...
float32
float32_mul(float32 a, float32 b, float_status_t *status)
{
...
float32
float32_div(float32 a, float32 b, float_status_t *status)
{
    int aSign, bSign, zSign;
    Bit16s aExp, bExp, zExp;
    Bit32u aSig, bSig, zSig;
...
float32
float32_sqrt(float32 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp, zExp;
    Bit32u aSig, zSig;
...
int
float32_compare(float32 a, float32 b, int quiet, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
...
float32
float32_min(float32 a, float32 b, float_status_t *status)
{
  if (get_denormals_are_zeros(status)) {
    a = float32_denormal_to_zero(a);
    b = float32_denormal_to_zero(b);
...
float32
float32_max(float32 a, float32 b, float_status_t *status)
{
  if (get_denormals_are_zeros(status)) {
    a = float32_denormal_to_zero(a);
    b = float32_denormal_to_zero(b);
...
float32
float32_minmax(float32 a, float32 b, int is_max, int is_abs, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float32_denormal_to_zero(a);
        b = float32_denormal_to_zero(b);
...
Bit32s
float64_to_int32(float64 a, float_status_t *status)
{
...
Bit32s
float64_to_int32_round_to_zero(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
...
Bit32u
float64_to_uint32_round_to_zero(float64 a, float_status_t *status)
{
    Bit64u aSig = extractFloat64Frac(a);
    Bit16s aExp = extractFloat64Exp(a);
    int aSign = extractFloat64Sign(a);
...
Bit64s
float64_to_int64(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
...
Bit64s
float64_to_int64_round_to_zero(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit64u aSig;
...
Bit64u
float64_to_uint64_round_to_zero(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit64u aSig, z;
...
Bit32u
float64_to_uint32(float64 a, float_status_t *status)
{
...
Bit64u
float64_to_uint64(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp, shiftCount;
    Bit64u aSig, aSigExtra;
...
float32
float64_to_float32(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp;
    Bit64u aSig;
...
float64
float64_round_to_int(float64 a, Bit8u scale, float_status_t *status)
{
...
float64
float64_frc(float64 a, float_status_t *status)
{
    int roundingMode = get_float_rounding_mode(status);
...
float64
float64_getexp(float64 a, float_status_t *status)
{
    Bit16s aExp = extractFloat64Exp(a);
    Bit64u aSig = extractFloat64Frac(a);
...
float64
float64_getmant(float64 a, float_status_t *status, int sign_ctrl, int interv)
{
    Bit16s aExp = extractFloat64Exp(a);
    Bit64u aSig = extractFloat64Frac(a);
    int aSign = extractFloat64Sign(a);
...
float64
float64_scalef(float64 a, float64 b, float_status_t *status)
{
    Bit64u aSig = extractFloat64Frac(a);
    Bit16s aExp = extractFloat64Exp(a);
    int aSign = extractFloat64Sign(a);
...
static float64
addFloat64Sigs(float64 a, float64 b, int zSign, float_status_t *status)
{
    Bit16s aExp, bExp, zExp;
...
static float64
subFloat64Sigs(float64 a, float64 b, int zSign, float_status_t *status)
{
    Bit16s aExp, bExp, zExp;
    Bit64u aSig, bSig, zSig;
    Bit16s expDiff;
...
float64
float64_add(float64 a, float64 b, float_status_t *status)
{
    int aSign = extractFloat64Sign(a);
    int bSign = extractFloat64Sign(b);
...
float64
float64_sub(float64 a, float64 b, float_status_t *status)
{
    int aSign = extractFloat64Sign(a);
    int bSign = extractFloat64Sign(b);
...
float64
float64_mul(float64 a, float64 b, float_status_t *status)
{
    int aSign, bSign, zSign;
    Bit16s aExp, bExp, zExp;
...
float64
float64_div(float64 a, float64 b, float_status_t *status)
{
    int aSign, bSign, zSign;
    Bit16s aExp, bExp, zExp;
    Bit64u aSig, bSig, zSig;
...
float64
float64_sqrt(float64 a, float_status_t *status)
{
    int aSign;
    Bit16s aExp, zExp;
...
int
float64_compare(float64 a, float64 b, int quiet, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
...
float64
float64_min(float64 a, float64 b, float_status_t *status)
{
  if (get_denormals_are_zeros(status)) {
    a = float64_denormal_to_zero(a);
    b = float64_denormal_to_zero(b);
...
float64
float64_max(float64 a, float64 b, float_status_t *status)
{
  if (get_denormals_are_zeros(status)) {
    a = float64_denormal_to_zero(a);
    b = float64_denormal_to_zero(b);
...
float64
float64_minmax(float64 a, float64 b, int is_max, int is_abs, float_status_t *status)
{
    if (get_denormals_are_zeros(status)) {
        a = float64_denormal_to_zero(a);
        b = float64_denormal_to_zero(b);
...
floatx80
float32_to_floatx80(float32 a, float_status_t *status)
{
    Bit32u aSig = extractFloat32Frac(a);
    Bit16s aExp = extractFloat32Exp(a);
    int aSign = extractFloat32Sign(a);
...
floatx80
float64_to_floatx80(float64 a, float_status_t *status)
{
    Bit64u aSig = extractFloat64Frac(a);
    Bit16s aExp = extractFloat64Exp(a);
    int aSign = extractFloat64Sign(a);
...
Bit32s
floatx80_to_int32(floatx80 a, float_status_t *status)
{
...
Bit32s
floatx80_to_int32_round_to_zero(floatx80 a, float_status_t *status)
{
    Bit32s aExp;
    Bit64u aSig, savedASig;
    Bit32s z;
...
Bit64s
floatx80_to_int64(floatx80 a, float_status_t *status)
{
    Bit32s aExp;
    Bit64u aSig, aSigExtra;
...
Bit64s
floatx80_to_int64_round_to_zero(floatx80 a, float_status_t *status)
{
    int aSign;
    Bit32s aExp;
    Bit64u aSig;
...
float32
floatx80_to_float32(floatx80 a, float_status_t *status)
{
    Bit64u aSig = extractFloatx80Frac(a);
    Bit32s aExp = extractFloatx80Exp(a);
    int aSign = extractFloatx80Sign(a);
...
float64
floatx80_to_float64(floatx80 a, float_status_t *status)
{
    Bit32s aExp;
    Bit64u aSig, zSig;
...
floatx80
floatx80_round_to_int(floatx80 a, float_status_t *status)
{
...
static floatx80
addFloatx80Sigs(floatx80 a, floatx80 b, int zSign, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    ...
    {
        pclog("Unsupported extended double precision floating encoding (ADD).\n");
        float_raise(status, float_flag_invalid);
        return floatx80_default_nan;
    }
...
static floatx80
subFloatx80Sigs(floatx80 a, floatx80 b, int zSign, float_status_t *status)
{
    pclog("SUB.\n");
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    Bit32s aExp, bExp, zExp;
    ...
    if (floatx80_is_unsupported(a) || floatx80_is_unsupported(b))
    {
        pclog("Unsupported extended double precision floating encoding (SUB).\n");
        float_raise(status, float_flag_invalid);
        return floatx80_default_nan;
    }
...
floatx80
floatx80_add(floatx80 a, floatx80 b, float_status_t *status)
{
    int aSign = extractFloatx80Sign(a);
    int bSign = extractFloatx80Sign(b);

    pclog("floatx80_add() a = %08x, b = %08x.\n", aSign, bSign);
    if (aSign == bSign)
...
floatx80
floatx80_sub(floatx80 a, floatx80 b, float_status_t *status)
{
    int aSign = extractFloatx80Sign(a);
    int bSign = extractFloatx80Sign(b);
...
floatx80
floatx80_mul(floatx80 a, floatx80 b, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    int aSign, bSign, zSign;
    Bit32s aExp, bExp, zExp;
...
floatx80
floatx80_div(floatx80 a, floatx80 b, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    int aSign, bSign, zSign;
    Bit32s aExp, bExp, zExp;
...
floatx80
floatx80_sqrt(floatx80 a, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    int aSign;
    Bit32s aExp, zExp;
...
float128
floatx80_to_float128(floatx80 a, float_status_t *status)
{
    Bit64u zSig0, zSig1;
...
floatx80
float128_to_floatx80(float128 a, float_status_t *status)
{
    Bit32s aExp;
    Bit64u aSig0, aSig1;
...
floatx80 floatx80_128_mul(floatx80 a, float128 b, float_status_t *status)
{
    const floatx80 floatx80_default_nan = packFloatx80(0, floatx80_default_nan_exp, floatx80_default_nan_fraction);
    Bit32s aExp, bExp, zExp;
...
static float128
subFloat128Sigs(float128 a, float128 b, int zSign, float_status_t *status)
{
    const float128 float128_default_nan = packFloat128(float128_default_nan_hi, float128_default_nan_lo);
...
float128
float128_add(float128 a, float128 b, float_status_t *status)
{
    int aSign = extractFloat128Sign(a);
...
float128
float128_sub(float128 a, float128 b, float_status_t *status)
{
    int aSign = extractFloat128Sign(a);
    int bSign = extractFloat128Sign(b);
...
float128
float128_mul(float128 a, float128 b, float_status_t *status)
{
    const float128 float128_default_nan = packFloat128(float128_default_nan_hi, float128_default_nan_lo);
...
float128
float128_div(float128 a, float128 b, float_status_t *status)
{
    const float128 float128_default_nan = packFloat128(float128_default_nan_hi, float128_default_nan_lo);
    int aSign, bSign, zSign;
    Bit32s aExp, bExp, zExp;
