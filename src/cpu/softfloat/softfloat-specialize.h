...
static __inline Bit16u extractFloat16Frac(float16 a)
{
    return a & 0x3FF;
}
...
static __inline Bit16s extractFloat16Exp(float16 a)
{
    return (a>>10) & 0x1F;
}
...
static __inline int extractFloat16Sign(float16 a)
{
    return a>>15;
}
...
static __inline float16 packFloat16(int zSign, int zExp, Bit16u zSig)
{
...
static __inline int float16_is_nan(float16 a)
{
...
static __inline int float16_is_signaling_nan(float16 a)
{
...
static __inline int float16_is_denormal(float16 a)
{
...
static __inline float16 float16_denormal_to_zero(float16 a)
{
...
static __inline commonNaNT float16ToCommonNaN(float16 a, float_status_t *status)
{
    commonNaNT z;
...
static __inline float16 commonNaNToFloat16(commonNaNT a)
{
...
static __inline Bit32u extractFloat32Frac(float32 a)
{
    return a & 0x007FFFFF;
}
...
static __inline Bit16s extractFloat32Exp(float32 a)
{
    return (a>>23) & 0xFF;
}
...
static __inline int extractFloat32Sign(float32 a)
{
    return a>>31;
}
...
static __inline float32 packFloat32(int zSign, Bit16s zExp, Bit32u zSig)
{
...
static __inline int float32_is_nan(float32 a)
{
...
static __inline int float32_is_signaling_nan(float32 a)
{
...
static __inline int float32_is_denormal(float32 a)
{
...
static __inline float32 float32_denormal_to_zero(float32 a)
{
...
static __inline commonNaNT float32ToCommonNaN(float32 a, float_status_t *status)
{
    commonNaNT z;
...
static __inline float32 commonNaNToFloat32(commonNaNT a)
{
...
static __inline float32 propagateFloat32NaNOne(float32 a, float_status_t *status)
{
...
static __inline Bit64u extractFloat64Frac(float64 a)
{
...
static __inline Bit16s extractFloat64Exp(float64 a)
{
...
static __inline int extractFloat64Sign(float64 a)
{
    return (int)(a>>63);
}
...
static __inline float64 packFloat64(int zSign, Bit16s zExp, Bit64u zSig)
{
...
static __inline int float64_is_nan(float64 a)
{
...
static __inline int float64_is_signaling_nan(float64 a)
{
...
static __inline int float64_is_denormal(float64 a)
{
...
static __inline float64 float64_denormal_to_zero(float64 a)
{
...
static __inline commonNaNT float64ToCommonNaN(float64 a, float_status_t *status)
{
    commonNaNT z;
...
static __inline float64 commonNaNToFloat64(commonNaNT a)
{
...
static __inline float64 propagateFloat64NaNOne(float64 a, float_status_t *status)
{
...
static __inline Bit64u extractFloatx80Frac(floatx80 a)
{
    return a.fraction;
}
...
static __inline Bit32s extractFloatx80Exp(floatx80 a)
{
    return a.exp & 0x7FFF;
}
...
static __inline int extractFloatx80Sign(floatx80 a)
{
    return a.exp>>15;
}
...
static __inline floatx80 packFloatx80(int zSign, Bit32s zExp, Bit64u zSig)
{
    floatx80 z;
    z.fraction = zSig;
    z.exp = (zSign << 15) + zExp;
...
static __inline int floatx80_is_nan(floatx80 a)
{
...
static __inline int floatx80_is_signaling_nan(floatx80 a)
{
...
static __inline int floatx80_is_unsupported(floatx80 a)
{
...
static __inline commonNaNT floatx80ToCommonNaN(floatx80 a, float_status_t *status)
{
    commonNaNT z;
...
static __inline floatx80 commonNaNToFloatx80(commonNaNT a)
{
    floatx80 z;
...
static __inline floatx80 propagateFloatx80NaNOne(floatx80 a, float_status_t *status)
{
...
static __inline Bit64u extractFloat128Frac1(float128 a)
{
    return a.lo;
}
...
static __inline Bit64u extractFloat128Frac0(float128 a)
{
...
static __inline Bit32s extractFloat128Exp(float128 a)
{
...
static __inline int extractFloat128Sign(float128 a)
{
    return (int)(a.hi >> 63);
}
...
static __inline float128 packFloat128Four(int zSign, Bit32s zExp, Bit64u zSig0, Bit64u zSig1)
{
    float128 z;
    z.lo = zSig1;
...
static __inline float128 packFloat128(Bit64u zHi, Bit64u zLo)
{
    float128 z;
    z.lo = zLo;
    z.hi = zHi;
...
static __inline int float128_is_nan(float128 a)
{
...
static __inline int float128_is_signaling_nan(float128 a)
{
...
static __inline commonNaNT float128ToCommonNaN(float128 a, float_status_t *status)
{
    commonNaNT z;
...
static __inline float128 commonNaNToFloat128(commonNaNT a)
{
    float128 z;
