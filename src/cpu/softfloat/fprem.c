...
static Bit64u
remainder_kernel(Bit64u aSig0, Bit64u bSig, int expDiff, Bit64u *zSig0, Bit64u *zSig1)
{
    Bit64u term0, term1;
    Bit64u aSig1 = 0;
...
static int
do_fprem(floatx80 a, floatx80 b, floatx80 *r, Bit64u *q, int rounding_mode, float_status_t *status)
{
...
int
floatx80_ieee754_remainder(floatx80 a, floatx80 b, floatx80 *r, Bit64u *q, float_status_t *status)
{
...
int
floatx80_remainder(floatx80 a, floatx80 b, floatx80 *r, Bit64u *q, float_status_t *status)
{
