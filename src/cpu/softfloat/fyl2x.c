...
static float128
poly_l2(float128 x, float_status_t *status)
{
    const float128 float128_one = packFloat128(BX_CONST64(0x3fff000000000000), BX_CONST64(0x0000000000000000));
    const float128 float128_ln2inv2 = packFloat128(BX_CONST64(0x400071547652b82f), BX_CONST64(0xe1777d0ffda0d23a));
...
static float128
poly_l2p1(float128 x, float_status_t *status)
{
    const float128 float128_two = packFloat128(BX_CONST64(0x4000000000000000), BX_CONST64(0x0000000000000000));
    const float128 float128_ln2inv2 = packFloat128(BX_CONST64(0x400071547652b82f), BX_CONST64(0xe1777d0ffda0d23a));
...
floatx80
fyl2x(floatx80 a, floatx80 b, float_status_t *status)
{
...
floatx80
fyl2xp1(floatx80 a, floatx80 b, float_status_t *status)
{
