...
//                addbyte(5+5+3+2+2+2+/*3+*/3+2+6+4+5+2+3);
        ...
        else if (params->fbzColorPath & FBZCP_TEXTURE_ENABLED)
        {
                if (voodoo->bilinear_enabled && (params->textureMode & 6))
                {
                        ...
                        if (state->tformat & 8)
                        {
                                addbyte(0x48); /*LEA RBX,[RBP+RBX*2]*/
                                addbyte(0x8d);
                                addbyte(0x5c);
                                addbyte(0x5d);
                                addbyte(0);
                                addbyte(0x48); /*LEA RDX,[RBP+RDX*2]*/
                                addbyte(0x8d);
                                addbyte(0x54);
                                addbyte(0x55);
                                addbyte(0);
                        ...
                        {
                                addbyte(0x48); /*ADD RBX, RBP*/
                                addbyte(0x01);
                                addbyte(0xeb);
                                addbyte(0x48); /*ADD RDX, RBP*/
                                addbyte(0x01);
                                addbyte(0xea);
                        }
                        if (state->clamp_s)
                        ...
                        if (state->tformat & 8)
                        {
                                addbyte(0x8b); /*MOV EDX,[RDX+RAX*2]*/
                                addbyte(0x14);
                                addbyte(0x42);
                                addbyte(0x8b); /*MOV EAX,[RBX+RAX*2]*/
                                addbyte(0x04);
                                addbyte(0x43);
                        }
                        else
                        {
                                addbyte(0x0f); /*MOVZX EDX,W[RDX+RAX]*/
                                addbyte(0xb7);
                                addbyte(0x14);
                                addbyte(0x02);
                                addbyte(0x0f); /*MOVZX EAX,W[RBX+RAX]*/
                                addbyte(0xb7);
                                addbyte(0x04);
                                addbyte(0x03);
                        }
                        ...
                        if (state->clamp_s)
                        {
                                ...
                                if (state->tformat & 8)
                                {
                                        addbyte(0x8b); /*MOV ECX, [RDX+RAX*2]*/
                                        addbyte(0x0c);
                                        addbyte(0x42);
                                        addbyte(0x8b); /*MOV EDX, [RDX+RAX*2-2]*/
                                        addbyte(0x54);
                                        addbyte(0x42);
                                        addbyte(-2);
                                        ...
                                        addbyte(0x89);
                                        addbyte(0xca);
                                        addbyte(0x8b); /*MOV ECX, [RBX+RAX*2]*/
                                        addbyte(0x0c);
                                        addbyte(0x43);
                                        addbyte(0x8b); /*MOV EAX, [RBX+RAX*2-2]*/
                                        addbyte(0x44);
                                        addbyte(0x43);
                                        addbyte(-2);
                        ...
                        else
                        {
                                ...
                                {
                                        addbyte(0x8a); /*MOV CL, [RDX]*/
                                        addbyte(0x0a);
                                        addbyte(0x8a); /*MOV CH, [RBX]*/
                                        addbyte(0x2b);
                                        addbyte(0x0f); /*MOVZX EDX,B[RDX+RAX]*/
                                        addbyte(0xb6);
                                        addbyte(0x14);
                                        addbyte(0x02);
                                        addbyte(0x0f); /*MOVZX EAX,B[RBX+RAX]*/
                                        addbyte(0xb6);
                                        addbyte(0x04);
                                        addbyte(0x03);
                        ...
                        {
                                case TEX_RGB332:
                                addbyte(0x49); /*MOV R8, rgb332*/
                                addbyte(0xb8);
                                addquad(rgb332);
                                addbyte(0x0f); /*MOVZX ECX, AL*/
                                addbyte(0xb6);
                                addbyte(0xc8);
                                addbyte(0x66); /*MOVD XMM0, [R8+RCX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x04);
                                ...
                                addbyte(0x60);
                                addbyte(0xc2);
                                addbyte(0x66); /*MOVD XMM1, [R8+RCX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x0c);
                                ...
                                addbyte(0x60);
                                addbyte(0xca);
                                addbyte(0x66); /*MOVD XMM3, [R8+ECX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x1c);
                                ...
                                addbyte(0x04);
                                addbyte(0x88);
                                addbyte(0x66); /*MOVD XMM1, [R8+RAX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x0c);
                                ...
                                addbyte(0x60);
                                addbyte(0xca);
                                addbyte(0x66); /*MOVD XMM3, [R8+RCX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x1c);
                                ...
                                addbyte(0xfd);
                                addbyte(0xc1);
                                addbyte(0x66); /*MOVD XMM1, [R8+EDX*4]*/
                                addbyte(0x41);
                                addbyte(0x0f);
                                addbyte(0x6e);
                                addbyte(0x0c);
                ...
                else
                {
                        ...
                        addbyte(0x8f);
                        addlong(offsetof(voodoo_state_t, lod));
                        addbyte(0x8a); /*MOV DL, params->tex_shift[RSI+RCX*4]*/
                        addbyte(0x94);
                        addbyte(0x8e);
                        addlong(offsetof(voodoo_params_t, tex_shift));
                        addbyte(0x48); /*MOV RBP, state->tex[RDI+RCX*8]*/
